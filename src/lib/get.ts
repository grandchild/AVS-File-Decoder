...
export default {
    ...
    CodePFBI(blob: Uint8Array, offset: number): [CodeSection, number] {
    ...
    CodeFBI(blob: Uint8Array, offset: number): [CodeSection, number] {
        const map: [string, number][] = [
            ['init', 2],
            ['perFrame', 1],
            ['onBeat', 0]
    ...
    CodeIFBP(blob: Uint8Array, offset: number): [CodeSection, number] {
        const map: [string, number][] = [
            ['init', 0],
            ['perFrame', 1],
            ['onBeat', 2],
    ...
    CodeIFB(blob: Uint8Array, offset: number): [CodeSection, number] {
        const map: [string, number][] = [
            ['init', 0],
            ['perFrame', 1],
            ['onBeat', 2]
    ...
    NtCodeIFB(blob: Uint8Array, offset: number): [CodeSection, number] {
        const map: [string, number][] = [
            ['init', 0],
            ['perFrame', 1],
            ['onBeat', 2]
    ...
    NtCodeIFBP(blob: Uint8Array, offset: number): [CodeSection, number] {
        const map: [string, number][] = [
            ['init', 0],
            ['perFrame', 1],
            ['onBeat', 2],
    ...
    LegacyCodeIFB(blob: Uint8Array, offset: number): [CodeSection, number] {
        const map: [string, number][] = [
            ['init', 0],
            ['perFrame', 1],
            ['onBeat', 2]
    ...
    CodeSection(blob: Uint8Array, offset: number, map: [string, number][], nt = false, fixedSize?: number): [CodeSection, number] {

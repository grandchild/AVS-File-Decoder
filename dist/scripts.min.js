...
function saveAvsAsJson(n,t){var o=convertPreset(n,t),e="#output";$(e).html(JSON.stringify(o,null,prettyPrint?"    ":null)),$(e).each(function(n,t){hljs.highlightBlock(t)}),console.log("loaded:\n"+atob(o))}function jsonPrintSpecials(n,t){return"convolutionMatrix"===n?t.join(","):t}var compat=!1,outputDir="",pedanticMode=!1,verbose=!0,allFields=!0,prettyPrint=!0;$(document).ready(function(){checkCompat(),log('<span class="danger">File API check: '+(compat?"success":"fail")+".</span>");var n=[];$("#preset").change(function(){n=loadDir(this,/\.avs$/),log("Found "+n.length+" files in directory.");for(var t=0;t<n.length;t++)loadFile(n[t],saveAvsAsJson)})});
...
function SelectText(e){var t=document,n=t.getElementById(e),o=null;if(t.body.createTextRange)o=t.body.createTextRange(),o.moveToElementText(n),o.select();else if(window.getSelection){var l=window.getSelection();o=t.createRange(),o.selectNodeContents(n),l.removeAllRanges(),l.addRange(o)}}hljs.initHighlightingOnLoad(),$(function(){$("#output").click(function(){SelectText("output")})});

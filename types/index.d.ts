...
/* input types -- ComponentDefinitions */
...
/* output types -- Preset with Components */
...
interface Component {
    type: string;
    group?: string;
    [fieldName: string]: ComponentFieldValue;
}
...
type ComponentFieldValue =
    ...
    |ColorMap
    |ConvolutionFilter
    |Component[]  // only EffectLists have subcomponents
    ;
...
type jsontypes = string|number|boolean;
